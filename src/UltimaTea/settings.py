"""
Django settings for UltimaTea project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY','django-insecure-2wkjgk=#^%u!8pt5sojotmcgt90-v9$s2@l))k600m*$&e!&*#')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DJANGO_DEBUG', '') != 'False'

ALLOWED_HOSTS = ['ultima-tea.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'UltimaTea.wsgi.application'
